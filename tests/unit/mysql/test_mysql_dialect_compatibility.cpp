...
TEST_F(MySQLDialectCompatibilityTest, TimestampBehavior) {
    ...
    std::string bothTimestampColumn = Dialect<MysqlTag>::generate_column_definition<SqlDate>("timestamp_col", bothTimestampTags);
...
TEST_F(MySQLDialectCompatibilityTest, StringLengthHandling) {
    ...
    std::string indexedZeroLengthColumn = Dialect<MysqlTag>::generate_column_definition<std::string>("id", indexedZeroLengthTags);
    ...
    std::string zeroLengthColumn = Dialect<MysqlTag>::generate_column_definition<std::string>("description", zeroLengthTags);
...
TEST_F(MySQLDialectCompatibilityTest, ConstraintCombinations) {
    ...
    std::string uniqueNotNullColumn = Dialect<MysqlTag>::generate_column_definition<std::string>("email", uniqueNotNullTags);
